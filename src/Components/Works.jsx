...
const Works = props => {
  return (
    <div className={"section works__main row align-items-center " + (props.active ? "slide" : "hide")}>
      <div className="card-group ">
        <div className="card">
          <img className="card-img-top" src="/images/rsvp.png" alt="RSVP'er" />
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text margin-bottom-70">
              Publicity for a fictional (for now) food delivery service, made
              with html and css
            </p>
            <div className="works__lnks">
              <a
